import { firstLetterUppercase,
  // IAuthBuyerMessageDetails,
  IAuthDocument, winstonLogger } from '@pandit-abhishek1/sharedservices';
...
const log: Logger = winstonLogger(`${config.ELASTICSEARCH_URL}`, 'AuthService Model', 'debug');
